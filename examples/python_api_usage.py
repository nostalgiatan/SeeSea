...
def main():
    ...
    server_internal = ApiServer(host="127.0.0.1", port=8080, network_mode="internal")
    ...
    server_external = ApiServer(host="0.0.0.0", port=8080, network_mode="external")
    ...
    server_dual = ApiServer(network_mode="dual")
