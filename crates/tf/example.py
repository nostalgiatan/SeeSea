...
def main():
    ...
    print("  MEMORY EFFICIENT: Only vectors and metadata stored!\n")
    ...
    for doc in documents:
        ...
        print("    ✓ Vectorized and stored (content discarded)")
    ...
    print("Stored per document:")
    print(f"  ✓ Vector ({embedder.get_dimension()} dimensions)")
    print("  ✓ Title")
    print("  ✓ URL")
    print("  ✗ Content (NOT stored - maximum memory efficiency!)")
