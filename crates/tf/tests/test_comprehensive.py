...
class TestCRUDOperations:
    ...
    def test_add_document_minimal(self, shared_store):
        ...
        shared_store.add(doc_id="test_add_2", content="Minimal document content.")
    ...
    def test_update_document(self, shared_store):
        ...
        # Update it
        shared_store.update("test_update_1", title="Updated Title", summary="Updated Summary")
    ...
    def test_delete_document(self, shared_store):
        ...
        # Add a document
        shared_store.add(doc_id="test_delete_1", content="Content for delete test.")
    ...
    def test_contains_operator(self, shared_store):
        """Test 'in' operator."""
        shared_store.add(doc_id="test_contains_1", content="Content for contains test.")
...
class TestBatchOperations:
    ...
    def test_add_batch_validation(self, shared_store):
        ...
        docs = [{"id": "valid", "content": "Valid content"}, {"id": "invalid"}]  # Missing content
    ...
    def test_delete_batch(self, shared_store):
        ...
        # Add documents
        for i in range(3):
            shared_store.add(doc_id=f"batch_del_{i}", content=f"Content {i}")
...
class TestUtilityMethods:
    ...
    def test_count(self, shared_store):
        ...
        shared_store.add(doc_id="test_count_1", content="Content for count test.")
...
class TestThreadSafety:
    ...
    def test_concurrent_reads(self, shared_store):
        ...
        # Add test document
        shared_store.add(
            doc_id="thread_test_1", content="Content for thread safety test.", title="Thread Test"
        )
    ...
    def test_concurrent_writes(self, shared_store):
        ...
        def add_worker(i):
            try:
                shared_store.add(doc_id=f"concurrent_add_{i}", content=f"Content {i}")
            except Exception as e:
                errors.append(e)
...
class TestMemoryEfficiency:
    ...
    def test_search_no_vectors(self, shared_store):
        ...
        shared_store.add(doc_id="memory_test_2", content="Content for vector test.")
    ...
    def test_streaming_memory(self, shared_store):
        ...
        for i in range(10):
            shared_store.add(doc_id=f"stream_mem_{i}", content=f"Content {i}")
