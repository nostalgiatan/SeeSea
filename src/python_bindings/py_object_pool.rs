...
use crate::cleaner::DatePageObjectPool;
use crate::python_bindings::py_date_page::PyDatePage;

/// Python包装的DatePage对象池统计信息
#[pyclass]
pub struct PyDatePageObjectPoolStats {
    stats: crate::cleaner::object_pool::DatePageObjectPoolStats,
}
...
impl PyDatePageObjectPool {
    ...
    pub fn put(&self, py_date_page: &mut PyDatePage) -> PyResult<()> {
        ...
        let empty_date_page =
            crate::cleaner::date_page::DatePage::new("", std::time::SystemTime::UNIX_EPOCH, "", "");
