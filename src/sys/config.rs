...
use crate::net::config::{DnsConfig, NetworkConfig, PoolConfig};
use crate::sys::types::{ComponentId, ResourceType};
...
impl DynamicConfigManager {
    ...
    pub async fn update_http_pool_config(
        ...
        match self.event_sender.send(event) {
            ...
            Err(e) => {
                ...
                Err(crate::errors::business_error(format!(
    ...
    /// 更新全局网络配置
    pub async fn update_network_config(&self, config: NetworkConfig) -> crate::errors::Result<()> {
        // 更新当前配置
