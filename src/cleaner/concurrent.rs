...
pub struct ConcurrentController {
    ...
    /// DatePage对象池
    date_page_pool: Arc<crate::cleaner::object_pool::DatePageObjectPool>,
}
...
impl ConcurrentController {
    ...
    pub fn new() -> Self {
        ...
        Self {
            ...
            date_page_pool: Arc::new(crate::cleaner::object_pool::DatePageObjectPool::new(
                min_pool_size,
                max_pool_size,
            )),
        }
    ...
    /// 获取DatePage对象池
    pub fn date_page_pool(&self) -> &Arc<crate::cleaner::object_pool::DatePageObjectPool> {
        &self.date_page_pool
    }
    ...
    /// 获取DatePage对象池统计信息
    pub fn date_page_pool_stats(&self) -> crate::cleaner::object_pool::DatePageObjectPoolStats {
