...
pub use ant_colony::AntColonyOptimization;
pub use concurrent::ConcurrentController;
pub use data_block::DataBlock;
pub use date_page::{DatePage, ExtraInfoItem, MapItem};
pub use md_parser::MDParser;
pub use object_pool::DatePageObjectPool;
pub use splitter::DataBlockSplitter;
...
pub struct Cleaner {
    ...
    /// 系统控制器引用，用于动态调控
    system_controller: Option<Arc<crate::sys::controller::SystemController>>,
}
...
impl Cleaner {
    ...
    /// 设置系统控制器，用于动态调控
    pub fn set_system_controller(
        &mut self,
        system_controller: Arc<crate::sys::controller::SystemController>,
    ) {
