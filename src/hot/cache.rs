...
use crate::cache::{CacheImplConfig, CacheInterface, CacheMode, ScopeCache};
...
impl HotTrendCache {
    ...
    pub fn new(ttl_secs: Option<u64>) -> Self {
        ...
        let scope_cache = CACHE_INTERFACE.scope(HOT_TREND_SCOPE);
        info!(
            "热榜缓存初始化，TTL: {:?}，作用域: {}",
            ttl, HOT_TREND_SCOPE
        );
...
mod tests {
    use super::*;
    use crate::hot::types::HotTrendItem;
